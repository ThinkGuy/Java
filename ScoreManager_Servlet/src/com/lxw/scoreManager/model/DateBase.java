...
public class DateBase {
	...
	public Student isExist(String studentId) {
		...
		try {
			while (resultSet.next()) {
				student.setStudentId(Integer.valueOf(resultSet.getString
						("studentId")));
	...
	public Student searchInfo(String studentId) {
		...
		String sql = "select studentId, name, chinese, english, math from " + STUDENT_TABLE + 
				" where studentId=" + studentId + ";";
		...
		try {
			...
			while (resultSet.next()) {
				...
				score.setChinese(Integer.parseInt(resultSet.getString("chinese")));
				score.setEnglish(Integer.parseInt(resultSet.getString("english")));
	 ...
	 * @return
	 */
	public boolean updateInfo(String studentId, int chinese, int english, int math) {
		String sql = "update " + STUDENT_TABLE + " set chinese=" + chinese + ",english="
				+ english + ",math=" + math + " where studentId=" + studentId + ";";
	...
	public boolean insertInfo(String studentId, String name, int chinese, 
		...
		String sql = "insert into " + STUDENT_TABLE + " (studentId, name, chinese, "
				+ "english, math) values(" + studentId + ",'" + name + "'," 
	...
	public static void main(String[] args) {
		...
		System.out.println(dateBase.insertInfo("20134018","sd", 88, 99, 77));
//		System.out.println(dateBase.isExist("20134019").getStudentId());
//		System.out.println(dateBase.searchInfo("20134019").getScore().getChinese());
